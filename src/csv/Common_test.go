...
var (
	...
	VALID_PARSE [][]string = [][]string{
		...
		{"1", "-2", "100", "101", "1.001000", "\"str1\"", "str1", "", "12/12/2012"},
		{"2", "-3", "101", "102", "1.002000", "\"str2\"", "str2", "true", "12/13/2012"},
	}
	...
	MISSING_COLUMNS_PARSE [][]string = [][]string{
		{"I8", "Ui", "Ui8", "F32", "S", "B", "T"},
		{"-2", "100", "101", "1.001000", "\"str1\"", "", "12/12/2012"},
		{"-3", "101", "102", "1.002000", "\"str2\"", "true", "12/13/2012"},
	}
	...
	MISSING_VALUES_PARSE [][]string = [][]string{
		{"I", "I8", "Ui", "Ui8", "F32", "S", "S1", "B", "T"},
		{"1", "", "100", "101", "1.001000", "\"str1\"", "", "", ""},
		{"2", "", "101", "102", "1.002000", "\"str2\"", "", "true", ""},
	}
	...
	MALFORMED_DIFFERING_ROW_LEN_PARSE [][]string = [][]string{
		{"I", "I8", "Ui", "Ui8", "F32", "S", "S1", "B", "T"},
		{"1", "-2", "100", "101", "1.001000", "\"str1\"", "str1", "false", "12/12/2012"},
		{"2", "-3", "101", "102", "1.002000", "\"str2\"", "str2", "true"},
	}
